...
import logging
# this will be responsible for reading the data batchwisw
def train_valid_generator(data_dir,IMAGE_SIZE,BATCH_SIZE, do_data_augmentation):
    #keyword arguments
    datagenerator_kwargs = dict(
        rescale = 1./255, #rescaled between 0 and 1
    ...
    dataflow_kwargs = dict(
        ...
        interpolation = "bilinear"#way to update the resizing operation. how to downgrade the images from higher dimension
    )
