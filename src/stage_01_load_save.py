...
from tqdm import tqdm # to get the progress bar of the copying
# import logging
...
def get_data(config_path):
    ...
    for source_download_dir, local_data_dir in tqdm(zip(source_download_dirs, local_data_dirs), total=2, desc= "list of folders", colour="red"):
        create_directory([local_data_dir]) #function defined in the all utils
        copy_file(source_download_dir, local_data_dir) # function defined above
